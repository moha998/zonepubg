...
function AppContent() {
  ...
  return (
    <div className="min-h-screen bg-bg-dark text-text-main font-sans selection:bg-primary/30 selection:text-white flex flex-col relative overflow-x-hidden">
      ...
      <header className="sticky top-0 z-[100] bg-[#101010] border-b border-white/10 h-[68px] flex items-center px-4 sm:px-8 lg:px-[72px]">
        <div className="max-w-[1360px] w-full mx-auto flex items-center justify-between">
          <div className="flex items-center gap-[44px]">
            ...
            >
              <h1 className="flex items-center gap-1">
                <span className="h-[34px] flex items-center px-2 border-[3px] border-primary text-primary text-[20px] font-[900]">PUBG</span>
                <span className="text-white text-[22px] font-[800]">ZONE</span>
              </h1>
            </div>

            <nav className="hidden lg:flex items-center gap-[44px] text-[14px] text-gray-400 font-bold h-full">
              {[
          ...
          <div className="flex items-center gap-5">
            ...
            <Moon size={22} className="text-gray-400 cursor-pointer hover:text-white transition" />
            ...
            {activeUser ? (
              <div className="relative group h-[68px] flex items-center">
                <div onClick={() => navigate('/dashboard')} className="flex items-center gap-2 cursor-pointer p-1 hover:bg-white/5 rounded-lg transition">
                  <img src={userProfile?.photoURL || activeUser.photoURL || `https://ui-avatars.com/api/?name=${encodeURIComponent(userProfile?.displayName || activeUser.displayName || 'User')}&background=F5C400&color=000`} alt="Avatar" className="w-[34px] h-[34px] rounded-md object-cover" />
                  <div className="hidden sm:flex flex-col text-right">
                    <span className="text-white text-sm font-bold">{userProfile?.displayName || activeUser.displayName || "مستخدم"}</span>
                  </div>
                </div>
              </div>
            ) : (
        ...
        <div className="max-w-[1360px] w-full mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
             <div className="flex flex-col lg:flex-row items-center gap-4 text-center lg:text-right">
                <h1 className="flex items-center gap-1 justify-center lg:justify-end">
                  <span className="h-[28px] flex items-center px-1.5 border-[2.5px] border-primary text-primary text-[16px] font-[900]">PUBG</span>
          ...
          <div className="flex flex-wrap justify-center items-center gap-6 text-[13px] text-[#D4D4D8] font-[600]">
            <a href="#" className="hover:text-primary transition">اتفاقية الاستخدام</a>
            <a href="#" className="hover:text-primary transition">سياسة الخصوصية</a>
            <a href="#" className="hover:text-primary transition">تواصل معنا</a>
            <a href="#" className="hover:text-primary transition">من نحن</a>
          </div>
            ...
            >
              <div className="p-6 flex justify-between items-center border-b border-white/5">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-black text-white gold-shimmer">ببجيكوم</span>
                </div>
                <button 
                  onClick={() => setShowMobileMenu(false)}
