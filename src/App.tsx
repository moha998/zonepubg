            ...
            <div className="flex items-center gap-6">
              ...
              <div className="text-right md:text-right">
                <h3 className="text-2xl md:text-4xl font-black gold-shimmer mb-2">
                  {tournament.id === 'daily-tournament' ? 'البطولة اليومية الكبرى' : 'بطولة ZONE PUBG الخاصة'}
                </h3>
...
function AppContent() {
  ...
  useEffect(() => {
    ...
    localStorage.setItem('zone-theme', theme);
  }, [theme]);
  ...
  return (
    <div className="min-h-screen bg-bg-dark text-text-main font-sans selection:bg-primary/30 selection:text-white flex flex-col relative overflow-x-hidden">
      ...
      {competitionSettings.find(s => s.id === 'global')?.isBannerActive && (
        <a 
          href={competitionSettings.find(s => s.id === 'global')?.bannerLink || "#"} 
          target="_blank" 
          rel="noopener noreferrer"
          ...
          <div className="flex items-center gap-[44px]">
            ...
            >
              <h1 className="flex items-center gap-1">
                <span className="h-[28px] flex items-center px-1.5 border-[2.5px] border-pubg-gold text-pubg-gold text-[16px] font-[900]">PUBG</span>
              ...
              <div className="p-6 flex justify-between items-center border-b border-white/5">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-primary/20 rounded-lg flex items-center justify-center">
                    <GameImage src="/logo.png" alt="ZONE PUBG" className="w-full h-full" />
                  </div>
                  <h1 className="flex items-center gap-1">
                    <span className="h-[28px] flex items-center px-1.5 border-[2.5px] border-pubg-gold text-pubg-gold text-[16px] font-[900]">PUBG</span>
                    <span className="text-white text-[18px] font-[800]">ZONE</span>
