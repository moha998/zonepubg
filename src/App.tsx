        ...
        <div className="max-w-[1360px] w-full mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
             <div className="flex flex-col lg:flex-row items-center gap-4 text-center lg:text-right">
                <h1 className="flex items-center gap-2 justify-center lg:justify-end">
          ...
          <div className="flex flex-wrap justify-center items-center gap-6 text-[13px] text-[#D4D4D8] font-[600]">
            <button onClick={() => navigate('/terms')} className="hover:text-primary transition">اتفاقية الاستخدام</button>
            <button onClick={() => navigate('/privacy')} className="hover:text-primary transition">سياسة الخصوصية</button>
