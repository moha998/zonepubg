                    ...
                    <div className="flex gap-2">
                      ...
                      {isAdmin && (
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            // TikTok sharing simulation
                            alert(`تم جاري تجهيز "رابط الخبر" للنشر على تيك توك: ${item.title}`);
                          }}
                          className="p-2 rounded-lg bg-white/5 text-slate-400 hover:text-[#ff0050] hover:bg-[#ff0050]/10 transition-all"
