...
import { Clock, Zap, Flame, Shield, Sparkles, Trophy, Target, Star, Gift, Package, Activity, Timer, EyeOff, Eye, Share2, Video } from 'lucide-react';
                    ...
                    {isAdmin && (
                      <div className="flex gap-2">
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            alert(`تم جاري تجهيز "فعالية ${event.title}" للنشر على تيك توك كفيديو ترويجي...`);
                          }}
                          className="p-1.5 rounded bg-[#ff0050]/20 text-[#ff0050] hover:bg-[#ff0050] hover:text-white border border-[#ff0050]/40 transition-all"
                          title="نشر على تيك توك"
                        >
