  ...
  return (
    <div className="min-h-screen bg-pubg-dark text-[#E2E8F0] font-sans selection:bg-pubg-gold selection:text-black" dir="rtl">
      <main className="max-w-[1280px] mx-auto px-4 md:px-8 py-8">
        ...
        {/* HERO SECTION */}
        <div className="relative h-[360px] rounded-2xl overflow-hidden mb-10 border border-pubg-border shadow-[0_20px_60px_rgba(0,0,0,0.5)] bg-pubg-card">
          <img 
            src="https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=2000" 
            className="absolute inset-0 w-full h-full object-cover opacity-30 mix-blend-luminosity"
            alt="ZONE PUBG"
          />
          <div className="absolute inset-0 bg-gradient-to-l from-black/10 via-black/80 to-black" />
          <div className="relative z-10 h-full flex flex-col justify-center px-10 max-w-2xl">
            <span className="text-pubg-gold text-sm mb-3 font-bold tracking-widest backdrop-blur-sm bg-black/30 w-fit px-3 py-1 rounded-full border border-pubg-border">بوابة ببجي النقية - [اسم المنشئ]</span>
          ...
          <div className="flex-1 space-y-12 order-1 lg:order-2 min-w-0">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                {[
                  { title: "رويال باس A6", sub: "Royal Pass", targetDate: new Date('2026-05-15T00:00:00Z'), img: "https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=600" },
                  { title: "مود الميكا المستقبلي", sub: "Mode", targetDate: new Date('2026-05-10T00:00:00Z'), img: "https://images.unsplash.com/photo-1552820728-8b83bb6b773f?q=80&w=600" },
                  { title: "صندوق مميز متخفي", sub: "Crate", targetDate: new Date('2026-05-05T12:00:00Z'), img: "https://images.unsplash.com/photo-1563986768609-322da13575f3?q=80&w=600" },
                  { title: "بطولة كأس المواهب", sub: "Tournament", targetDate: new Date('2026-05-20T18:00:00Z'), img: "https://images.unsplash.com/photo-1511512578047-dfb367046420?q=80&w=600" }
                ].map((item, idx) => {
                  return (
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                {[
                  { title: "تحديث ببجي موبايل 3.2", sub: "الإصدار الأخير", date: "جديد", img: "https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=600", link: "https://www.pubgmobile.com/ar/news.shtml" },
                  { title: "ملاحظات التحديث والميزات الجديدة", sub: "التحديثات", date: "جديد", img: "https://images.unsplash.com/photo-1563986768609-322da13575f3?q=80&w=600", link: "https://www.pubgmobile.com/ar/news.shtml" },
                  { title: "أخبار مجتمع ببجي والبطولات", sub: "البطولات", date: "تحديث مستمر", img: "https://images.unsplash.com/photo-1511512578047-dfb367046420?q=80&w=600", link: "https://esports.pubgmobile.com/" },
                  { title: "الفعاليات والأحداث الحالية", sub: "الأحداث", date: "مستمر", img: "https://images.unsplash.com/photo-1552820728-8b83bb6b773f?q=80&w=600", link: "https://www.pubgmobile.com/ar/home.shtml" }
                ].map((item, idx) => (
                  <div 
                    key={idx} 
                  ...
                  >
                    ...
                    <div className="p-5 flex-1 flex flex-col justify-between">
                      <div>
                        <div className="text-xs text-pubg-gold font-bold mb-1 tracking-wide">{item.sub}</div>
