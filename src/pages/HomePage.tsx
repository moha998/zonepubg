      ...
      <main className="max-w-[1280px] mx-auto px-4 md:px-8 py-8">
        ...
        <div className="relative h-[420px] rounded-2xl overflow-hidden mb-10 border border-pubg-border shadow-[0_20px_60px_rgba(0,0,0,0.5)] bg-pubg-card group">
          ...
          <div className="relative z-10 h-full flex flex-col justify-center px-10 max-w-2xl">
            <span className="text-pubg-gold text-sm mb-3 font-bold tracking-widest backdrop-blur-sm bg-black/30 w-fit px-3 py-1 rounded-full border border-pubg-border tracking-tighter uppercase">المركز الرسمي للمحترفين - ZONEPUBG</span>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 space-y-12 order-1 lg:order-2 min-w-0">
            ...
            {/* ABOUT THE PLATFORM (TikTok Review Requirement) */}
            <section className="bg-pubg-card/50 border border-pubg-border rounded-2xl p-8 relative overflow-hidden backdrop-blur-sm">
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-pubg-gold/0 via-pubg-gold/40 to-pubg-gold/0" />
              <div className="flex flex-col md:flex-row gap-8 items-center">
                <div className="flex-1">
                  <h2 className="text-pubg-gold text-sm tracking-[0.2em] font-bold mb-2">ABOUT THE PLATFORM</h2>
                  <h3 className="text-2xl font-black text-white mb-4">ما هي منصة ZONEPUBG وكيف تعمل؟</h3>
                  <p className="text-[#A1A1AA] leading-relaxed text-[15px] mb-6">
                    ZONEPUBG هي المنصة العربية الأولى المتكاملة لمجتمع لاعبي ببجي موبايل. نحن نوفر أدوات احترافية تشمل حاسبة نقاط التقييم (الكونكر)، ومقارنة إحصائيات الأسلحة بدقة، بالإضافة إلى مكتبة محدثة من أكواد الحساسية لأشهر اللاعبين والأجهزة (جوال، آيباد، محاكي).
                  </p>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="flex items-start gap-3">
                      <div className="p-2 bg-pubg-gold/10 rounded-lg text-pubg-gold">
                        <Users size={18} />
                      </div>
                      <div>
                        <h4 className="text-white font-bold text-sm">مجتمع تفاعلي</h4>
                        <p className="text-[#777] text-xs">نربط اللاعبين بأحدث الأخبار والفعاليات العالمية.</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="p-2 bg-pubg-gold/10 rounded-lg text-pubg-gold">
                      ...
                      <div>
                        <h4 className="text-white font-bold text-sm">أدوات ذكية</h4>
                        <p className="text-[#777] text-xs">تحليل البيانات لمساعدة اللاعبين على تحسين مستواهم.</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="w-full md:w-[240px] aspect-square rounded-2xl border border-white/5 bg-black/40 flex items-center justify-center p-6 text-center">
                   <div className="space-y-4">
                      <div className="relative inline-block">
                        <div className="w-16 h-16 border-2 border-pubg-gold rounded-xl rotate-45 flex items-center justify-center">
                           <Shield className="-rotate-45 text-pubg-gold" size={32} />
                        </div>
                      </div>
                      <h4 className="text-white font-bold text-sm">منصة آمنة 100%</h4>
                      <p className="text-[11px] text-[#555]">نحن نلتزم بأعلى معايير الخصوصية والأمان لجميع مستخدمينا.</p>
                   </div>
                </div>
              </div>
            </section>
