...
import { Gift, Infinity as InfinityIcon, LogIn, ExternalLink, Calendar, Users, Trophy, User, Lock, Timer, Zap, Trash2, Plus, BarChart3, CheckCircle2, Loader2, Eye, EyeOff } from 'lucide-react';
                          ...
                          <div className="flex gap-2">
                            <button
                              ...
                              {isAdmin && (
                                <div className="flex gap-2">
                                  <button
                                    onClick={() => onToggleVisibility("giveaways", giveaway.id, giveaway.isHidden || false)}
                                    className={`p-3 rounded-xl border transition-all ${giveaway.isHidden ? 'border-red-500 text-red-500 bg-red-500/10' : 'border-primary text-primary bg-primary/10 hover:bg-primary hover:text-black'}`}
                                    title={giveaway.isHidden ? "إظهار" : "إخفاء"}
                                  >
                                    {giveaway.isHidden ? <EyeOff size={20} /> : <Eye size={20} />}
                                  </button>
                                  <button
                                    onClick={() =>
                                      deleteItem("giveaways", giveaway.id)
                                    }
                                    className="p-3 bg-red-500/10 text-red-500 rounded-xl hover:bg-red-500 hover:text-white border border-red-500/20 transition-all"
                                  >
                                    <Trash2 size={20} />
                                  </button>
                                </div>
