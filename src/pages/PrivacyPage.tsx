  ...
  const policies = [
    {
      ...
      content: "قد يقوم موقع ZONEPUBG بجمع معلومات محدودة عن المستخدم مثل بيانات تسجيل الدخول، وملفات تعريف الارتباط (cookies)، والتحليلات لتحسين تجربة المنصة."
    },
    {
      title: "2. دمج تيك توك",
      icon: <Globe className="text-primary" size={24} />,
      content: "قد تصل عمليات دمج تسجيل الدخول عبر تيك توك (TikTok) إلى معلومات الملف الشخصي الأساسية بناءً على تفويض المستخدم الخاص."
    },
    {
      title: "3. حماية البيانات",
      icon: <Lock className="text-primary" size={24} />,
      content: "نحن لا نقوم ببيع المعلومات الشخصية لأطراف ثالثة. نستخدم تقنيات حماية متقدمة لضمان أن بياناتك لا يمكن الوصول إليها إلا من قبلك."
    },
    {
      title: "4. الموافقة",
      icon: <CheckCircle2 className="text-primary" size={24} />,
      content: "باستخدامك هذا الموقع، فإنك توافق على ممارسات الخصوصية الخاصة بنا الموضحة في هذه الصفحة لضمان أفضل تجربة لك."
    }
  ];
      ...
      <div className="pro-card p-8 md:p-12 relative overflow-hidden backdrop-blur-2xl border-white/5">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <p className="text-slate-400 text-lg max-w-3xl leading-relaxed">
            خصوصيتك هي أولويتنا القصوى في ZONEPUBG. نحن نلتزم بالشفافية الكاملة حول كيفية تعاملنا مع بياناتك وضمان أمانها بأحدث التقنيات.
          </p>
