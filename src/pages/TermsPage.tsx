  ...
  const sections = [
    {
      ...
      content: "باستخدامك لموقع PUBG ZONE، فإنك توافق على الالتزام بشروط الاستخدام هذه. إذا لم تكن موافقاً، يرجى التوقف عن استخدام الموقع."
    },
    {
      ...
      <div className="pro-card p-8 md:p-12 relative overflow-hidden backdrop-blur-2xl border-white/5">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <p className="text-slate-400 text-lg max-w-3xl leading-relaxed">
            يرجى قراءة شروط الخدمة بعناية لضمان أفضل تجربة لك ولأعضاء مجتمع PUBG ZONE. نحن نسعى لتوفير بيئة آمنة واحترافية لجميع اللاعبين.
          </p>
