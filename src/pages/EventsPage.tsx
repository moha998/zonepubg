                  ...
                  {events.length > 0 ? (
                    events.map((event) => (
                      <motion.div
                        ...
                        className="pro-card p-6 border-white/5 bg-white/2 hover:border-primary/30 transition-all flex items-start gap-6 relative group"
                      >
                        ...
                        {isAdmin && (
                          <div className="absolute top-4 left-4 flex gap-2">
                             ...
                             <button
                                ...
                                className="p-1.5 rounded bg-black/80 text-red-500 border border-red-500/20 hover:bg-red-500 hover:text-white transition-all"
                                title="حذف"
                             >
                                <Trash2 size={14} />
                             </button>
                ...
                >
                  ...
                  {isAdmin && (
                    <div className="absolute top-4 left-4 z-10 flex gap-2">
                       <button
                          onClick={() => onToggleVisibility("clips", clip.id, clip.isHidden || false)}
                          className={`p-1.5 rounded bg-black/80 transition-all border ${clip.isHidden ? 'border-red-500 text-red-500' : 'border-primary text-primary hover:bg-primary hover:text-black'}`}
                          title={clip.isHidden ? "إظهار" : "إخفاء"}
                       >
                          {clip.isHidden ? <EyeOff size={14} /> : <Eye size={14} />}
                       </button>
                       <button
                          onClick={() => deleteItem("clips", clip.id)}
                          className="p-1.5 rounded bg-black/80 text-red-500 border border-red-500/20 hover:bg-red-500 hover:text-white transition-all"
                          title="حذف"
                       >
                          <Trash2 size={14} />
