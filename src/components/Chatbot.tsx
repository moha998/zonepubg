...
`;
      ...
      const response = await ai.models.generateContent({
        ...
        config: {
          ...
          systemInstruction: `أنت الآن "الذكاء الاصطناعي المركزي لمنصة ZONE PUBG". دورك هو العمل كخبير تقني، محلل بيانات، ومدرب محترف في لعبة ببجي موبايل.
          ...
          >
            ...
            <div className="p-4 bg-primary text-black flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="font-bold text-sm">مساعد ZONE PUBG</h3>
