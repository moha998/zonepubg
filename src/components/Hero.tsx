...
export default function Hero() {
  return (
    <section className="relative w-full h-[450px] flex items-center overflow-hidden rounded-b-3xl">
      <OptimizedImage 
        src="https://image.pollinations.ai/prompt/PUBG%20Mobile%20Warrior%20standing%20on%20Erangel%20Hill%20Dramatic%20Sky?width=1280&height=450&nologo=true&seed=hero2" 
        alt="PUBG Background" 
